...
<Picture
  src="/images/cg-project-game.png"
  alt="Example of a game level during play mode"
/>
<Picture
  src="/images/cg-project-editor.png"
  alt="Example of the same level but in editor mode"
/>
