...
an unofficial REST API I made for Blizzard’s [Heroes of the Storm](https://heroesofthestorm.com),
a game I often played with my friends. Since the game still haven't
provided its own API, I put together a scrapper to gather data from stats websites, which didn’t provide any APIs either. To maximize the efficiency of the API by caching the retrieved data,
